        ...
        spine: {
          ...
          chest: {
            ...
            upperarml: {
              [path]: [0, 0, 9, 0, 0, 0, 0];
              lowerarml: {
                [path]: [0, 0, 9, 0, 0, 0, 0, 0];
                wristl: {
                  [path]: [0, 0, 9, 0, 0, 0, 0, 0, 0];
                  handl: {
                    [path]: [0, 0, 9, 0, 0, 0, 0, 0, 0, 0];
                    handslotl: {
                      [path]: [0, 0, 9, 0, 0, 0, 0, 0, 0, 0, 0];
                    };
                  };
                };
              };
            ...
            upperarmr: {
              [path]: [0, 0, 9, 0, 0, 0, 1];
              lowerarmr: {
                [path]: [0, 0, 9, 0, 0, 0, 1, 0];
                wristr: {
                  [path]: [0, 0, 9, 0, 0, 0, 1, 0, 0];
                  handr: {
                    [path]: [0, 0, 9, 0, 0, 0, 1, 0, 0, 0];
                    handslotr: {
                      [path]: [0, 0, 9, 0, 0, 0, 1, 0, 0, 0, 0];
                    };
                  };
                };
              };
            ...
            head: {
              [path]: [0, 0, 9, 0, 0, 0, 2];
              face: {
                [path]: [0, 0, 9, 0, 0, 0, 2, 0];
                eyeselectorbase: {
                  [path]: [0, 0, 9, 0, 0, 0, 2, 0, 0];
                  eyeselector: {
                    [path]: [0, 0, 9, 0, 0, 0, 2, 0, 0, 0];
                  };
                };
              };
              Chamo_Base_Hair: {
                [path]: [0, 0, 9, 0, 0, 0, 2, 1];
              };
              Chamo_Earring_Cross: {
                [path]: [0, 0, 9, 0, 0, 0, 2, 2];
              };
              Chamo_Ears: {
                [path]: [0, 0, 9, 0, 0, 0, 2, 3];
              };
              Chamo_Long_Hair: {
                [path]: [0, 0, 9, 0, 0, 0, 2, 4];
              };
            };
          };
        };
...
export function getNode(spec: typeof SceneScene.Chamo_Rig.Chamo_Eyes): Promise<SkinnedMesh>;
export function getNode(spec: typeof SceneScene.Chamo_Rig.Chamo_Hands): Promise<SkinnedMesh>;
export function getNode(spec: typeof SceneScene.Chamo_Rig.Chamo_Head): Promise<SkinnedMesh>;
export function getNode(spec: typeof SceneScene.Chamo_Rig.Chamo_Legs): Promise<SkinnedMesh>;
export function getNode(spec: typeof SceneScene.Chamo_Rig.Chamo_Mouth): Promise<SkinnedMesh>;
