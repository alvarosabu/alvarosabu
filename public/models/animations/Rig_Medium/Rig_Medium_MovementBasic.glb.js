...
import gltfPath from "./Rig_Medium_MovementBasic.glb";
        ...
        spine: {
          ...
          chest: {
            ...
            upperarmr: {
              [path]: [0, 0, 6, 0, 1, 0, 1],
              lowerarmr: {
                [path]: [0, 0, 6, 0, 1, 0, 1, 0],
                wristr: {
                  [path]: [0, 0, 6, 0, 1, 0, 1, 0, 0],
                  handr: {
                    [path]: [0, 0, 6, 0, 1, 0, 1, 0, 0, 0],
                    handslotr: {
                      [path]: [0, 0, 6, 0, 1, 0, 1, 0, 0, 0, 0],
                    },
                  },
                },
              },
            ...
            upperarml: {
              [path]: [0, 0, 6, 0, 1, 0, 2],
              lowerarml: {
                [path]: [0, 0, 6, 0, 1, 0, 2, 0],
                wristl: {
                  [path]: [0, 0, 6, 0, 1, 0, 2, 0, 0],
                  handl: {
                    [path]: [0, 0, 6, 0, 1, 0, 2, 0, 0, 0],
                    handslotl: {
                      [path]: [0, 0, 6, 0, 1, 0, 2, 0, 0, 0, 0],
                    },
                  },
                },
              },
