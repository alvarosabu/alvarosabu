...
<template>
  <div class="p-4 md:p-8 xl:p-16 pb-[calc(1rem_+_env(safe-area-inset-bottom))] md:pb-[calc(2rem_+_env(safe-area-inset-bottom))] xl:pb-[calc(4rem_+_env(safe-area-inset-bottom))] min-h-svh flex flex-col">
    <div
    ...
    >
      ...
      <footer class="flex flex-col gap-4 md:flex-row md:items-end md:justify-between p-6 md:p-8 z-1">
        ...
        <div
          class="flex items-center justify-start md:justify-end gap-3 text-sm md:text-base font-mono"
          :class="[revealTransition, 'delay-[240ms]', isRevealed ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-1']"
        >
          <div
            id="landing-controls"
    ...
    <div
      id="landing-credit"
      class="relative z-2 flex justify-start md:justify-end pt-2 pl-6 pr-6 md:pl-0 md:pr-8 text-[10px] leading-none font-mono text-muted pointer-events-none empty:hidden"
    />
  </div>
</template>
